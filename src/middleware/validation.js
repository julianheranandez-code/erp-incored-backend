...
const schemas = {
  ...
  createProject: Joi.object({
    ...
    project_type: Joi.string().valid('ftth','structured_cabling','ftth_homepass','maintenance','support','consulting','swap','hdd','HDD','other').optional(),
    ...
    budget_allowance: Joi.number().min(0).optional(),
    budget_fuel: Joi.number().min(0).optional(),
    budget_tools: Joi.number().min(0).optional(),
    budget_others: Joi.number().min(0).optional(),
