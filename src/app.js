...
const arInvoicesRoutes = require('./routes/ar-invoices');
const internalPOsRoutes = require('./routes/internal-pos');
const apBillsRoutes = require('./routes/ap-bills');
...
app.use('/api/time/timesheets',  require('./routes/time/timesheets'));
app.use('/api/time/schedules',   require('./routes/time/schedules'));
...
app.use('/api/treasury', require('./routes/treasury1d'));

app.use('/api/treasury', require('./routes/treasury2a'));
